// Verification Key Hash: 0d6055d01470be0d34f88f502a1c88e204c147b37f66aff7b365870b1b471e2f
...
library UltraVerificationKey {
    function verificationKeyHash() internal pure returns(bytes32) {
        return 0x0d6055d01470be0d34f88f502a1c88e204c147b37f66aff7b365870b1b471e2f;
    }
    ...
    function loadVerificationKey(uint256 _vk, uint256 _omegaInverseLoc) internal pure {
        assembly {
            ...
            mstore(add(_vk, 0x80), 0x1a476fbad3270a793025f6f3575dc7fbce4100568b6d3634bf0ff16c38df49f3) // vk.Q1.x
            mstore(add(_vk, 0xa0), 0x06fe527e36e331182111c6e3f879151437a7653302f4fa04de6ade4833a3b0c8) // vk.Q1.y
            mstore(add(_vk, 0xc0), 0x1115851c2f59d2360b5cdcdcc12003450775ec97eedc21f7d38507bef6196b1b) // vk.Q2.x
            mstore(add(_vk, 0xe0), 0x153968dd61f5d5222f3483e5cbebdfb31fe19fcb93fd19c84416d7735e45bae6) // vk.Q2.y
            mstore(add(_vk, 0x100), 0x13cbfafc766e5053c50b5caea6d1ebed760b853a20889a37e4d58a1ff6ed9a08) // vk.Q3.x
            mstore(add(_vk, 0x120), 0x23c0040eda68d489c3b6d2fd55f55371457cf60d3faa9fe628cecb440e7a5225) // vk.Q3.y
            mstore(add(_vk, 0x140), 0x09020535b1ce3e9aeb590ba3af886170fa91c56cc36e9eb19a94b6e6f03ab8c0) // vk.Q4.x
            mstore(add(_vk, 0x160), 0x2d83a37d84a9c297a36bc9534b5be0765fee24b6832c5ccee4f7c4340ac315e5) // vk.Q4.y
            mstore(add(_vk, 0x180), 0x0d39db9c5fce92ac5bccfe8fa3e47662bb5472edc0fe47fa25a604b790e4838e) // vk.Q_M.x
            mstore(add(_vk, 0x1a0), 0x17c0d93d0cfc8ba5c6174d6645b1e31126e9df3a7695f3618ca2947d6d906909) // vk.Q_M.y
            mstore(add(_vk, 0x1c0), 0x1b7c4fbcf2ef9df85e7576ea41bfd5445b33746855cc407bcdf00e25877f2730) // vk.Q_C.x
            mstore(add(_vk, 0x1e0), 0x177182cd96b1557dd3099d5a9e569cc3a730358b63bd87d7d2ec445d3efd7588) // vk.Q_C.y
            mstore(add(_vk, 0x200), 0x1b8134ac62d27907acd8138151be8e7b40b4b56929216cee7ab2cff48b8fd1de) // vk.Q_ARITHMETIC.x
            mstore(add(_vk, 0x220), 0x144024929c7eefbae02e4d46c01835f25114b6e9d123f685dbe9dcabb3096355) // vk.Q_ARITHMETIC.y
            mstore(add(_vk, 0x240), 0x013182b98b8ba37d5545ad6b84113f54226961c952c0d37173d7155a408b791c) // vk.QSORT.x
            mstore(add(_vk, 0x260), 0x0b4b5ebc2af525084315ad94ddfd20c15910232c66cd782db75e44d3c0d95785) // vk.QSORT.y
            ...
            mstore(add(_vk, 0x300), 0x03d9581d4bef4f93eee283c50909e7d1cad150fadd544bee53235f8988079944) // vk.SIGMA1.x
            mstore(add(_vk, 0x320), 0x290758a10657fd54ad40a013e046e0ebd1de85583e8ed37c82021e55e20932d8) // vk.SIGMA1.y
            mstore(add(_vk, 0x340), 0x160934490b1726f5ba512dc231b522df0562560cbc066cdc88e35690f840e2d3) // vk.SIGMA2.x
            mstore(add(_vk, 0x360), 0x0ace55221519ba91507500e7d9afa5898a0bbbf6740c6b378a2d7b058805821e) // vk.SIGMA2.y
            mstore(add(_vk, 0x380), 0x1025faf2ee107dd4857c74718d07278d0dabd7673c16dc2d6f0a53fa2a9a3616) // vk.SIGMA3.x
            mstore(add(_vk, 0x3a0), 0x1268d089954cd55e47defaba260bc1dbf13f280478a299fd10e623c224bf8fb8) // vk.SIGMA3.y
            mstore(add(_vk, 0x3c0), 0x2de87a8afabd20d70b1cd4afe77bf24ce74a3c7a8d215ff234bf2b06f68ced80) // vk.SIGMA4.x
            mstore(add(_vk, 0x3e0), 0x1aa90c59affa60ef232a0fae7990f74b8c73f0747afd9af14bfe2efe446c44b9) // vk.SIGMA4.y
            mstore(add(_vk, 0x400), 0x19b61a351dd84dba67e693c94427f2371d1fd92415b89e248b2751824f04c473) // vk.TABLE1.x
            mstore(add(_vk, 0x420), 0x0ba2752df3fcfc80035121b3992c46f921726aec523701b5d685439f588998e3) // vk.TABLE1.y
            mstore(add(_vk, 0x440), 0x0a3f709ca24aa47884f370f915e6e8c3a48c42670a632effaf16611e94ff5bb5) // vk.TABLE2.x
            mstore(add(_vk, 0x460), 0x2cbbd6ff4c1c60a5ca2e33a1635ffc965519beecc980740fe89164363abbbe81) // vk.TABLE2.y
            mstore(add(_vk, 0x480), 0x14083ff6ecafd5b48769e45d54be164de5c86508b6598803a0b917ea9344b92b) // vk.TABLE3.x
            mstore(add(_vk, 0x4a0), 0x105ec995f2823a4915341542e77f122554a8f4b486c30958890c6dd487dbdffb) // vk.TABLE3.y
            mstore(add(_vk, 0x4c0), 0x0f0659a7b88acc874481318fe28c2ce6e7f3aea8c7686da45bd62e9a918ab25a) // vk.TABLE4.x
            mstore(add(_vk, 0x4e0), 0x2a6ff08dfc03f23751808a9b45a3e311ddc85b7dd06a7d98daf3bf394f297990) // vk.TABLE4.y
            mstore(add(_vk, 0x500), 0x20e4ab1ed33d4001eeed44e4f08cb06eeb4c63cad3acfea6f8c6e481e3470dce) // vk.TABLE_TYPE.x
            mstore(add(_vk, 0x520), 0x21bf9de24c74c2a3d760028be09cae33366813ed3838c7a812b4a0c3af166f92) // vk.TABLE_TYPE.y
            mstore(add(_vk, 0x540), 0x127ea20b238763d4877f56b683971d0dd0a5671aa3bc57e629501d5d268e9c90) // vk.ID1.x
            mstore(add(_vk, 0x560), 0x2209117be5f3f72531adc11f924b0d87939fc1ad3284706530c40d6f6403c2ce) // vk.ID1.y
            mstore(add(_vk, 0x580), 0x022d219d437ac37c170b4a75fe70500ebe201efc0116ab2204b83d7c65d800ce) // vk.ID2.x
            mstore(add(_vk, 0x5a0), 0x1ade4c05f0e1ed491efac4ad3ea0871a341276c179c5e6b65cd03113216e2c3e) // vk.ID2.y
            mstore(add(_vk, 0x5c0), 0x0be937ca392681272307c0f1af3cb5309b3d7a4b3d4ea798af43fea0e7241f42) // vk.ID3.x
            mstore(add(_vk, 0x5e0), 0x0d4f92fdb031842819028e9e1cc3f28516894ca11931b1795b94ea5fb09fd850) // vk.ID3.y
            mstore(add(_vk, 0x600), 0x0fcd3b148e016ce5571c0a3b8c8b82925285ffc922bb7062290683c084d5c55b) // vk.ID4.x
            mstore(add(_vk, 0x620), 0x284a949668adb043dc7898f80705cfca1bdd229482213cf783756f2ab7ade7cc) // vk.ID4.y
